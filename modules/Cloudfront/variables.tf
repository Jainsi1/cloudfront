...
variable acm_certificate_arn {
  description = "ACM Certificate ARN. Keep it null, value will be updated during run time."
  default     = ""
  type        = string
}

variable cdn_bucket_domain_name {
  description = "S3 bucket domain name for Origin. Keep it null, value will be updated during run time."
  default     = ""
  type        = string
}
